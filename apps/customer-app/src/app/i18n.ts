...
const copy = {
  zh: {
    ...
    add: "加入购物车", customize: "口味与加料", close: "关闭详情", flip: "点击卡片翻转查看详情", back: "返回正面",
  ...
  de: {
    ...
    add: "In den Warenkorb", customize: "Geschmack & Extras", close: "Details schließen", flip: "Karte für Details antippen", back: "Vorderseite",
  ...
  en: {
    ...
    add: "Add to cart", customize: "Flavors & extras", close: "Close details", flip: "Tap card to see details", back: "Front side",
