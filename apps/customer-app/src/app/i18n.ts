...
const copy = {
  zh: {
    ...
    orderTableLocked: "这桌正在结账，暂时不能下单，请呼叫服务员",
    ...
    nextPage: "下一页", prevPage: "上一页", releaseToTurn: "松手翻页", pullForNext: "上拉或轻点翻页", endOfMenu: "菜单到底了", photo: "照片", featuredDefault: "精选推荐", featuredEyebrow: "主厨精选", featuredView: "查看详情", setsPage: "套餐", setsEyebrow: "精心搭配"
  },
  de: {
    ...
    orderTableLocked: "Dieser Tisch wird gerade abgerechnet — bitte den Service rufen",
    ...
    nextPage: "Weiter", prevPage: "Zurück", releaseToTurn: "Loslassen zum Blättern", pullForNext: "Hochziehen oder tippen", endOfMenu: "Ende der Karte", photo: "Foto", featuredDefault: "Empfehlungen", featuredEyebrow: "Vom Küchenchef", featuredView: "Details", setsPage: "Menüs", setsEyebrow: "Zusammengestellt"
  },
  en: {
    ...
    orderTableLocked: "This table is being settled — please ask a waiter",
    ...
    nextPage: "Next", prevPage: "Previous", releaseToTurn: "Release to turn the page", pullForNext: "Pull up or tap", endOfMenu: "End of the menu", photo: "Photo", featuredDefault: "Signature", featuredEyebrow: "Chef's selection", featuredView: "View", setsPage: "Set menus", setsEyebrow: "Put together"
  }
} as const;
